...
public class TestThoiKhoaBieu {
	...
	public void TC_01() throws InterruptedException {
		   WebElement flow = driver.findElement(By.xpath("//span[contains(text(),'Thời khoá biểu')]"));
	        flow.click();
	        Thread.sleep(2000);

	        if (flow.isDisplayed()) {
	            driver.findElement(By.xpath("//span[normalize-space()='Import TKB']")).click();
	        }

	        Thread.sleep(2000);

	        driver.findElement(By.xpath("//span[@id='select2-term-container']//span[1]"))
	                .click();
	        Thread.sleep(2000);

	        WebElement valueToSelect = driver.findElement(By.xpath("//li[text()='999']"));
	        valueToSelect.click();
	        ...
	        WebElement valueToSelect2 = driver.findElement(By.xpath("//li[text()='Công nghệ thông tin']"));
	        valueToSelect2.click();
	        driver.findElement(By.xpath(" //button[@id='submit-all']"))
            .click();
    Thread.sleep(2000);
		    ...
		    if (toast.isDisplayed()) {
		        ...
		        Assert.assertTrue(message.contains("File chưa được upload hoặc sai định dạng"));
		    }
    ...
    Thread.sleep(2000);
		    ...
		    if (toast.isDisplayed()) {
		        String message = toast.getText();
		        Assert.assertTrue(message.contains("Bạn chưa chọn học kỳ và ngành"));
		    }
		    driver.close();
	}
	// 
